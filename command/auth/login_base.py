...
class LoginBase(CommandBase):
    ...
    def handle_login(self, nickname, uid):
        ...
        agent_configs = [
            ...
            {"name": "Zhao_Lei", "x": 28, "y": 46, "asset": "premade_08",
            ...
            {"name": "Tutor_John", "x": 68, "y": 72, "asset": "premade_16", "bio": "Peer Tutor. Wants to be visible.",
             "goal": "Sit in a visible spot in the Dessert Shop to wait for students."},
            {"name": "Mentee_Alice", "x": 70, "y": 74, "asset": "premade_17", "bio": "Struggling Student. Panicked.",
            ...
            {"name": "Coffee_Snob", "x": 82, "y": 22, "asset": "premade_14", "bio": "Connoisseur. Judgemental.",
             "goal": "Sip a premium coffee and judge the cafe's interior."},
            {"name": "Sleepy_Student", "x": 84, "y": 24, "asset": "premade_15", "bio": "Exhausted. Needs rest.",
             "goal": "Find a soft sofa in the Dessert Shop to nap."},
            {"name": "Couple_Boy", "x": 86, "y": 26, "asset": "premade_18", "bio": "Boyfriend. Focused on intimacy.",
             "goal": "Find a private table to talk romantically."},
            {"name": "Couple_Girl", "x": 88, "y": 28, "asset": "premade_19",
             "bio": "Girlfriend. Socially performative.", "goal": "Take cute photos in the Dessert Shop."},
            {"name": "Sun_Ying", "x": 50, "y": 50, "asset": "premade_09", "bio": "Freshman. Lonely.",
             "goal": "Sit in the crowd at the Park just to feel present."},
            {"name": "Gamer_Tom", "x": 52, "y": 52, "asset": "premade_11", "bio": "Casual Gamer. Lazy.",
             "goal": "Slouch on a bench in the Park and play mobile games."},
            {"name": "Yoga_Girl", "x": 54, "y": 54, "asset": "premade_24", "bio": "Wellness Enthusiast.",
             "goal": "Find open space in the Park to stretch."},
            {"name": "Phone_Call_Guy", "x": 56, "y": 56, "asset": "premade_25", "bio": "Business Student. Loud.",
             "goal": "Pace around the Park talking loudly on the phone."},
            {"name": "Sketching_Artist", "x": 58, "y": 58, "asset": "premade_26", "bio": "Visual Artist. Observer.",
             "goal": "Find a vantage point in the Park to sketch people."},
            {"name": "Lost_Freshman", "x": 40, "y": 40, "asset": "premade_01", "bio": "New Student. Disoriented.",
             "goal": "Wander between buildings looking for signs."},

            # 4. 管理与观察型 (Admin/Staff)
            {"name": "Prof_Chen", "x": 5, "y": 10, "asset": "premade_02", "bio": "Architecture Professor. Researcher.",
             "goal": "Patrol campus to observe furniture usage."},
            {"name": "Admin_Liu", "x": 20, "y": 10, "asset": "premade_10", "bio": "Administrator. Rule enforcer.",
             "goal": "Patrol public areas to enforce rules."},
            {"name": "Janitor_Bob", "x": 25, "y": 15, "asset": "premade_04", "bio": "Janitor. Friendly.",
             "goal": "Clean public areas and greet students."},
            {"name": "Visitor_Parent", "x": 30, "y": 20, "asset": "premade_23", "bio": "Parent. Critical evaluator.",
