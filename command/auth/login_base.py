...
class LoginBase(CommandBase):
    ...
    def handle_login(self, nickname, uid):
        ...
        # === 30个智能体配置列表 (坐标已分散) ===
        agent_configs = [
            # 1. 沉浸专注型 (目标：寻找高私密、强隔音、无视觉干扰的边缘或独立空间)
            {"name": "SongJunbo", "x": 26, "y": 44, "asset": "premade_01",
             "bio": "Physics PhD candidate. High noise sensitivity. Requires absolute isolation for derivations.",
             "goal": "Find the most silent, visually enclosed study corner in the teaching building to think deeply for 3 hours."},
            {"name": "ZhaoLei", "x": 28, "y": 46, "asset": "premade_08",
             "bio": "Medical Student. Rote learner. Carrying heavy books and easily fatigued.",
             "goal": "Find an ergonomic chair in a well-lit, quiet area to memorize anatomy without being disturbed."},
            {"name": "LiWenpeng", "x": 30, "y": 48, "asset": "premade_20",
             "bio": "Traditional Scholar. Dislikes open, high-traffic spaces.",
             "goal": "Find a highly private spot that feels like a secluded library carrel."},
            {"name": "ZhangJiayuan", "x": 32, "y": 50, "asset": "premade_22",
             "bio": "Grad student. Dissertation deadline in 2 hours. Extremely stressed.",
             "goal": "Find any available seat immediately in a quiet zone to type furiously. Ignore all social interactions."},
            {"name": "WangXiaoyang", "x": 34, "y": 52, "asset": "premade_02",
             "bio": "Data Researcher. Multi-device user (laptop, tablet, papers).",
             "goal": "Find a large, spacious desk in a low-traffic area to spread out multiple devices."},
            {"name": "ZhangYizhe", "x": 10, "y": 80, "asset": "premade_05",
             "bio": "Literature Student. Seeks aesthetic environments for inspiration.",
             "goal": "Find a quiet lounge with natural sunlight and a window view to read poetry."},
            {"name": "KongYue", "x": 12, "y": 82, "asset": "premade_21",
             "bio": "Musician. Auditory learner wearing noise-canceling headphones.",
             "goal": "Find a seat facing a wall or window to minimize visual distractions while listening to audio files."},
            {"name": "LiLinfan", "x": 14, "y": 84, "asset": "premade_03",
             "bio": "Job Seeker. Anxious about upcoming online interview.",
             "goal": "Find a completely secluded and acoustically isolated corner to practice interview answers aloud."},

            # 2. 协作交互型 (目标：寻找开放、半开放的研讨区，依赖白板、大桌，容忍噪音)
            {"name": "WangZhonghao", "x": 55, "y": 60, "asset": "premade_06",
             "bio": "Student Team Leader preparing for a national competition. Loud and dominant.",
             "goal": "Find an open discussion area or atrium to hold a loud strategy session with teammates."},
            {"name": "RenZhuo", "x": 57, "y": 62, "asset": "premade_07",
             "bio": "Team member. Follows WangZhonghao but gets anxious in pure chaos.",
             "goal": "Search the collaboration zones to find WangZhonghao for the group meeting."},
            {"name": "LinGuangting", "x": 60, "y": 65, "asset": "premade_12",
             "bio": "Architecture Student making a physical model. Needs space and doesn't mind mess.",
             "goal": "Find a large collaborative table to assemble a building model with group mates."},
            {"name": "GuoZhiyuan", "x": 62, "y": 67, "asset": "premade_13",
             "bio": "Design Critic. Loves brainstorming and debating concepts.",
             "goal": "Find LinGuangting in the collaborative area to fiercely debate their model design."},
            {"name": "Li_Hua", "x": 65, "y": 70, "asset": "premade_03",
             "bio": "Student Union President. Highly extroverted networker.",
             "goal": "Wander the high-traffic atriums and main corridors to bump into people and greet them."},
            {"name": "KeMeixiang", "x": 68, "y": 72, "asset": "premade_16",
             "bio": "Teaching Assistant holding impromptu office hours. Wants to be easily found.",
             "goal": "Sit in a highly visible spot near the main stairs or atrium to wait for students' questions."},
            {"name": "Alice", "x": 70, "y": 74, "asset": "premade_17",
             "bio": "Struggling Student. Panicked about the upcoming exam.",
             "goal": "Frantically search the public study areas to find TA KeMeixiang for help."},

            # 3. 休闲社交型 (目标：寻找电源、咖啡、风景，驻留时间短，位于交通流线交汇处)
            {"name": "Zhang_Wei", "x": 80, "y": 20, "asset": "premade_04",
             "bio": "CS Undergrad. Battery at 5%. Desperately needs power and caffeine.",
             "goal": "Find a spot with a power outlet near a vending machine or lounge to recharge."},
            {"name": "ChenLang", "x": 82, "y": 22, "asset": "premade_14",
             "bio": "Campus trendsetter. Takes breaks between classes.",
             "goal": "Find a stylish seating area in the main hall to sit back, drink coffee, and people-watch."},
            {"name": "WangZining", "x": 84, "y": 24, "asset": "premade_15",
             "bio": "Exhausted from pulling an all-nighter. Needs a quick physical recovery.",
             "goal": "Find a soft sofa in a comfortable lounge area to take a 20-minute nap."},
            {"name": "CaiJianhua", "x": 86, "y": 26, "asset": "premade_18",
             "bio": "Boyfriend hanging out between classes. Focused on intimacy.",
             "goal": "Find a semi-private seating node along the corridor to chat romantically."},
            {"name": "MaJiangping", "x": 88, "y": 28, "asset": "premade_19",
             "bio": "Girlfriend. Enjoys taking photos of campus life.",
             "goal": "Find an aesthetically pleasing spot with good lighting to take photos and chat with CaiJianhua."},
            {"name": "ZhaoZheng", "x": 50, "y": 50, "asset": "premade_09",
             "bio": "Freshman. Lonely and seeking a sense of ambient belonging.",
             "goal": "Sit in a bustling, crowded atrium area just to feel the presence of others."},
            {"name": "YangZhaoyu", "x": 52, "y": 52, "asset": "premade_11",
             "bio": "Casual Gamer taking a break.",
             "goal": "Slouch on a comfortable bench in a transit area to play mobile games for 15 minutes."},
            {"name": "LiuChang", "x": 54, "y": 54, "asset": "premade_24",
             "bio": "Wellness Enthusiast. Stiff from sitting too long.",
             "goal": "Find an open, spacious area near the windows to stretch physical limbs."},
            {"name": "YuanJiameng", "x": 56, "y": 56, "asset": "premade_25",
             "bio": "Extroverted student handling club business.",
             "goal": "Pace around the main corridors while talking loudly on the phone."},
            {"name": "LiBoyu", "x": 58, "y": 58, "asset": "premade_26",
             "bio": "Visual Artist observing social dynamics.",
             "goal": "Find a high vantage point overlooking the atrium to sketch the crowd."},
            {"name": "GuanTao", "x": 40, "y": 40, "asset": "premade_01",
             "bio": "New Student. Disoriented and lost in the teaching building.",
             "goal": "Wander the corridor intersections looking for building maps or someone to ask for directions."},

            # 4. 管理与观察型 (目标：遍历空间，不长期驻留，测试空间的移动性与视野)
            {"name": "Prof_ChenWeiya", "x": 5, "y": 10, "asset": "premade_02",
             "bio": "Civil Engineering Professor. Observing spatial utilization.",
             "goal": "Patrol the teaching building's public areas to observe how students are using the informal spaces."},
            {"name": "Admin_Liu", "x": 20, "y": 10, "asset": "premade_10",
             "bio": "Building Administrator. Strict rule enforcer.",
             "goal": "Patrol the corridors and lounges to ensure students are not moving furniture or blocking fire exits."},
            {"name": "Staff_Wang", "x": 25, "y": 15, "asset": "premade_04",
             "bio": "Campus Janitor. Friendly and task-oriented.",
             "goal": "Move through the atriums and lounges to clean up empty coffee cups, occasionally greeting students."},
            {"name": "Visitor_Zhang", "x": 30, "y": 20, "asset": "premade_23",
             "bio": "Visiting Scholar. Unfamiliar with the layout.",
             "goal": "Walk through the main public spaces to evaluate the academic atmosphere and facilities."}
        ]
        # agent_configs = [
        #     # 1. 沉浸专注型
        #     {"name": "SongJunbo", "x": 26, "y": 44, "asset": "premade_01",
